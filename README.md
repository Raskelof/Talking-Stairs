...
I'm happy with the end result of this project but I haven't reached the end goal. The get real practical use of the device I would like to identify WHO is walking down the stairway to play a personalized message instead of a general greeting. To be continued...
